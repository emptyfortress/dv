...
const rows = [
	...
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Еще какая-то версия конструктора',
		url: 'https://application-dun.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'bpmn0',
	...
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Usability test, юзабилити тестирование',
		url: 'https://application-git-newstatus-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'bpmn3',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Следующая версия конструктора (mercury style)',
		url: 'https://mercurynew.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'bpmn1',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Версия конструктора с деревом в запросах + drag-drop условий',
		url: 'https://mercurynew-git-tree-emptyfortress-projects.vercel.app/request/2',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'bpmn2',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Версия c "простым" конструктором запросов и представлений',
		url: 'https://mercurynew-git-ai-emptyfortress-projects.vercel.app/request1/2',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'bpmn2',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Конструктор приложений (Заявка) - с полной Заявкой',
		url: 'https://application-git-start2-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'Zayavka',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Конструктор приложений (Дизайн) - старый прототип с обновленным дизайном для ролика',
		url: 'https://application-git-start2-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
	...
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Конструктор приложений (бывшая последняя версия)',
		url: 'https://mercurynew-git-bug-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'last',
	},
	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Конструктор приложений (откляченная версия для первого релиза)',
		url: 'https://mercurynew-git-release-1-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: false,
		pic: 'last',
...

	{
		...
		client: 'web-client',
		field: 'концепт',
		descr: 'Конструктор приложений (последний)',
		url: 'https://mercurynew-git-dev-emptyfortress-projects.vercel.app/',
		tags: ['концепт'],
		tugs: ['конструктор'],
		latest: true,
		pic: 'last',
